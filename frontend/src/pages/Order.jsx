                ...
                <div key={item.userId+index}>
                   ...
                   <div className='border rounded'>
                                    ...
                                    <div key={product.productId+index} className='flex  gap-3 bg-white'>
                                        ...
                                        <div>
                                          ...
                                          <div className='flex items-center gap-5 mt-1'>
                                            <div className='text-lg font-medium text-rose-500'>{displayCurrency(product.price)}</div>
                      ...
                      <div className='font-bold  ml-auto w-fit lg:text-lg'>
                        Total Amount : <span className='text-2xl'>{displayCurrency(item.totalAmount)}</span>
                      </div>
                   </div>
                </div>
              )
